...
const Navbar = () => {
  return (
    <div className='fixed w-full h-15 bg-gradient-to-t from-[#11111130] to-[#111]  z-[999] backdrop-blur-sm flex flex-row items-center justify-around '>
        ...
        <a href="https://chromewebstore.google.com/detail/kaanch-wallet/jicpmdkafljkkppgpellcjhfhdmjpogm" target="_blank" rel="noopener noreferrer"><div className="flex items-center gap-2 text-cyan-500 py-2 md:px-10 px-5 rounded-md bg-[#262323]">
